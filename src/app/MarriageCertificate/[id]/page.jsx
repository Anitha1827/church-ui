  ...
  return (
   ...
   <div className='parent'>
    <div className="wid">
        ...
        <h2 align="center">Marriage Certificate</h2><br/>
        <form>
            <label>Kept It</label>
            <input className="kep" disabled="text" value={data.textArea}/><br/><br/>
            <input className="kept" disabled="text"/><br/><br/>
            <input className="kept" disabled="text"/><br/>
            <br/><br/>
        ...
        <br/><br/>
        <p className="font">I Certify that the above extract is a true copy</p>
        <label>Date: </label>
        <input disabled className="date" type="text" value={convertIdToDate(id)} />
    </div>
    </div>
   </>
  )
